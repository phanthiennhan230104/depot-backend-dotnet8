...
### 1. [Kiến trúc Clean Architecture](./ARCHITECTURE.md)
...
### 3. [Hướng dẫn Setup](./SETUP_GUIDE.md)
- Yêu cầu hệ thống
- Cài đặt từng bước
...
### 4. [Hướng dẫn Testing](./TESTING_GUIDE.md)
...
### 5. [Curriculum Training](./TRAINING_CURRICULUM.md)
...
Hãy bắt đầu với [Setup Guide](./SETUP_GUIDE.md) để cài đặt và chạy dự án, sau đó theo [Training Curriculum](./TRAINING_CURRICULUM.md) để học từng bước một cách có hệ thống.
